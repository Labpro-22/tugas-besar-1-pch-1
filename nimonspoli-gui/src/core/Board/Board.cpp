...
string tileTypeToString(TileType type) {
    ...
    case TileType::CARD:     return "CARD";
...
string tileNameToString(TileName name) {
    switch (name) {
    case TileName::GO:          return "GO";
    case TileName::GARUT:       return "GARUT";
    case TileName::COMMON_FUND: return "DANA_UMUM";
    case TileName::TASIKMALAYA: return "TASIKMALAYA";
    case TileName::INCOME_TAX:  return "PAJAK_PENGHASILAN";
    case TileName::ST_GAMBIR:   return "STASIUN_GAMBIR";
    case TileName::BOGOR:       return "BOGOR";
    case TileName::FESTIVAL:    return "FESTIVAL";
    case TileName::DEPOK:       return "DEPOK";
    case TileName::BEKASI:      return "BEKASI";
    case TileName::JAIL:        return "PENJARA";
    case TileName::MAGELANG:    return "MAGELANG";
    case TileName::PLN:         return "PLN";
    case TileName::SOLO:        return "SOLO";
    case TileName::YOGYAKARTA:  return "YOGYAKARTA";
    case TileName::ST_BANDUNG:  return "STASIUN_BANDUNG";
    case TileName::MALANG:      return "MALANG";
    case TileName::SEMARANG:    return "SEMARANG";
    case TileName::SURABAYA:    return "SURABAYA";
    case TileName::FREE_PARK:   return "BEBAS_PARKIR";
    case TileName::MAKASSAR:    return "MAKASSAR";
    case TileName::CHANCE:      return "KESEMPATAN";
    case TileName::BALIKPAPAN:  return "BALIKPAPAN";
    case TileName::MANADO:      return "MANADO";
    case TileName::ST_TUGU:     return "STASIUN_TUGU";
    case TileName::PALEMBANG:   return "PALEMBANG";
    case TileName::PEKANBARU:   return "PEKANBARU";
    case TileName::PAM:         return "PAM";
    case TileName::MEDAN:       return "MEDAN";
    case TileName::GO_TO_JAIL:  return "PERGI_KE_PENJARA";
    case TileName::BANDUNG:     return "BANDUNG";
    case TileName::DENPASAR:    return "DENPASAR";
    case TileName::MATARAM:     return "MATARAM";
    case TileName::ST_GUBENG:   return "STASIUN_GUBENG";
    case TileName::JAKARTA:     return "JAKARTA";
    case TileName::LUX_GOODS:   return "PAJAK_BARANG_MEWAH";
    case TileName::IKN:         return "IBU_KOTA_NUSANTARA";
    default:                    return "UNKNOWN";
    }
}
...
int Board::findTileIndexByCode(const string& code) const {
    for (int i = 0; i < size; ++i) {
        if (tile[i] && tile[i]->getCode() == code) return i;
    }
    return -1;
}
...
void StreetTile::onLanded(Player& p, GameState& gs) {
    ...
    if (property->getStatus() == PropertyStatus::BANK) {
        ...
        if (property->getOwnerId() != p.getID()) {
...
int StreetTile::calculateRent(int /*diceTotal*/) const {
    ...
    if (!sp) return 0;
    // false = status monopoli ditentukan GameMaster, bukan Tile
    return static_cast<int>(sp->calculateRentPrice());
}
...
void GoTile::onLanded(Player& p, GameState& gs) {
    ...
    if (bank) bank->payPlayer(&p, salary);
}
...
bool JailTile::isInmate(Player& p) const {
    for (auto inmate : inmates) {
        if (inmate->getID() == p.getID()) return true;
    }
    return false;
}
...
// FIX #16: gs.getGameBoard() → gs.getBoard(); p.moveTo() → p.setCurrPetak()
