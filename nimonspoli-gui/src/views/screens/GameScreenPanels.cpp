...
void GameScreen::drawRightPanel()
{
    ...
    if (isRealMode()) {
        ...
        switch(ph) {
            case GamePhase::PLAYER_TURN:       phaseStr = "PLAYER_TURN"; break;
            case GamePhase::AWAITING_BUY:      phaseStr = "AWAITING_BUY"; break;
            case GamePhase::AWAITING_TAX:      phaseStr = "AWAITING_TAX"; break;
            case GamePhase::AWAITING_FESTIVAL: phaseStr = "AWAITING_FESTIVAL"; break;
            case GamePhase::SHOW_CARD:         phaseStr = "SHOW_CARD"; break;
            case GamePhase::AUCTION:           phaseStr = "AUCTION"; break;
